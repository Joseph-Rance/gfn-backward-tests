...
def get_bck_loss_free(_log_z, traj_log_p_f, _log_rewards, traj_log_p_b, info, **_kwargs):
...
def get_bck_probs_soft_smooth_tlm(trajs, _traj_lens, actions, raw_embeddings, embedding_structure, bck_models, a=0.5, **_kwargs):
    bck_action_probs = get_action_probs(*raw_embeddings[0], *embedding_structure[0], *bck_models, random_action_prob=0, apply_masks=False)
    single_state_p_b_std = torch.std(bck_action_probs, dim=1)
...
def get_bck_probs_biased_tlm(trajs, traj_lens, actions, raw_embeddings, embedding_structure, bck_models, multiplier=5, ns=[3, 4, 5], **_kwargs):
    ...
    return biased_tlm_log_p_b, tlm_log_p_b, {"mean_single_state_p_b_std": -1, "std_single_state_p_b_std": -1}  # expensive to compute
...
soft_tlm = (get_bck_probs_soft_smooth_tlm, get_bck_loss_tlm)
smooth_tlm = (get_bck_probs_soft_smooth_tlm, get_bck_loss_smooth_biased_tlm)
