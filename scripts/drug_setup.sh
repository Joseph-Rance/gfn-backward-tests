...
python src/drug_design/data/building_blocks/subsample_building_blocks.py --random True --n 10000 --filename short_building_blocks.txt
python src/drug_design/data/building_blocks/sanitize_building_blocks.py --building_blocks_filename short_building_blocks_subsampled_10000.txt --output_filename sanitised_bbs.txt
