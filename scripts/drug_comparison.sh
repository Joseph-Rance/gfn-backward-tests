...
python -m src.drug_design.tasks.main --config-idx 0 --preference-strength 0.2
cp -r results results_drug_uniform_1
python -m src.drug_design.tasks.main --config-idx 0 --preference-strength 0.4 # TODO*
cp -r results results_drug_uniform_2
python -m src.drug_design.tasks.main --config-idx 0 --preference-strength 1.0
...
python -m src.drug_design.tasks.main --config-idx 0 --preference-strength 0.2
cp -r results results_drug_free_0
python -m src.drug_design.tasks.main --config-idx 1 --preference-strength 0.4 # TODO*
cp -r results results_drug_free_0
...
python -m src.drug_design.tasks.main --config-idx 2 --preference-strength 0.2
cp -r results results_drug_tlm_1
python -m src.drug_design.tasks.main --config-idx 2 --preference-strength 0.4 # TODO*
cp -r results results_drug_tlm_2
python -m src.drug_design.tasks.main --config-idx 2 --preference-strength 1.0
...
python -m src.drug_design.tasks.main --config-idx 3 --preference-strength 0.4 # TODO*
cp -r results results_drug_maxent_2
...
python -m src.drug_design.tasks.main --config-idx 4 --preference-strength 1.0
cp -r results results_drug_dqn_7
...
python -m src.drug_design.tasks.main --config-idx 5 --preference-strength 1.0
cp -r results results_drug_reiforce_5
...
python -m src.drug_design.tasks.main --config-idx 6 --preference-strength 1.0
cp -r results results_drug_ac_5
...
python -m src.drug_design.tasks.main --config-idx 7 --preference-strength 1.0
cp -r results results_drug_ppo_8

# <best method from graph_building>
python -m src.drug_design.tasks.main --config-idx 8 # TODO*
cp -r results results_drug_new_0
